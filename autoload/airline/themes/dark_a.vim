...
"
" For this, the dark_a.vim, theme, this is defined as
let g:airline#themes#dark_a#palette = {}

" Keys in the dictionary are composed of the mode, and if specified the
" override.  For example:
"   * g:airline#themes#dark_a#palette.normal
"       * the colors for a statusline while in normal mode
"   * g:airline#themes#dark_a#palette.normal_modified
"       * the colors for a statusline while in normal mode when the buffer has
"         been modified
"   * g:airline#themes#dark_a#palette.visual
...
" let g:airline#themes#dark_a#palette.normal = airline#themes#generate_color_map(
...
" let g:airline#themes#dark_a#palette.normal = {
...
let g:airline#themes#dark_a#palette.accents = {
      \ 'red': [ '#ff0000' , '' , 160 , ''  ]
      \ }
...
if get(g:, 'loaded_ctrlp', 0)
  let g:airline#themes#dark_a#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
