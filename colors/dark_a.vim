...
" Last Updated: Mer  6 Nov 10:36:46 2019
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi CursorColumn guifg=NONE guibg=#0a5555 guisp=NONE gui=NONE cterm=NONE
  hi CursorLine guifg=NONE guibg=#0a5555 guisp=NONE gui=NONE cterm=NONE
  hi CursorLineNr guifg=#b7cff9 guibg=#0a5555 guisp=NONE gui=NONE cterm=NONE
  ...
  hi Todo guifg=#df5f00 guibg=#990000 guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi CursorLineNr ctermfg=153 ctermbg=23 cterm=NONE
  ...
  hi Todo ctermfg=166 ctermbg=88 cterm=NONE
...
if s:t_Co >= 8
  ...
  hi CursorLineNr ctermfg=LightGrey ctermbg=LightBlue cterm=NONE
  ...
  hi Todo ctermfg=LightRed ctermbg=DarkRed cterm=NONE
...
" Color: C001_DarkGreen rgb(  0,  26,  37)       ~         DarkGreen
" Color: C002_Orange    rgb(240, 142,  72)       ~         LightRed
" Color: C003_LightGray rgb(183, 207, 249)       ~         LightGrey
" Color: C004_LightGreen  rgb(156, 240, 135)     ~         LightGreen
" Color: C005_DarkBlue    rgb(  0,  38,  53)     ~         DarkBlue
" Color: C006_LightGreen  rgb(  0, 204, 204)     ~         LightGreen
" Color: C007_Telemagenta rgb(196,  48,  96)     ~         LightMagenta
" Color: C008_LightGrey   rgb(230, 230, 220)     ~         LightGrey
" Color: C009_SquirrelGrey rgb(119, 146, 158)    ~         LightGrey
" Color: C010_GreenBlue   rgb(  0,  56,  77)     ~         DarkBlue
" Color: C011_ZinkYellow  rgb(255, 204,  27)     ~         LightYellow
" Color: C012_PastelBlue  rgb( 81, 127, 141)     ~         LightBlue
" Color: C013_LightBlue   rgb( 28, 141, 178)     ~         LightBlue
" Color: C014_Pink        rgb(251, 148,  25)     ~         LightGrey
" Color: C015_AntiquePink rgb(255,  90, 103)     ~         LightMagenta
" Color: C016_Telegrey4   rgb(183, 207, 249)     ~         LightBlue
" Color: C017_DustyGrey rgb(127, 127, 127)       ~         LightGrey
" Color: C018_Orange3   rgb(255, 165,   0)       ~         LightRed
...
" Color: C033_Blue      rgb( 10,  85,  85)       ~         LightBlue
" Color: C034_Grey      rgb( 90,  90,  90)       ~         DarkGrey
" Color: C035_Orange    rgb(223,  95,   0)       ~         LightRed
" Color: C036_Red       rgb(153,   0,   0)       ~         DarkRed
